  ...
  return (
    <View style={styles.container} testID={id}>
      ...
      <View style={styles.propertydetails}>
        <Text h4 style={[styles.colorGrey, styles.fontBold]}>Offers Over</Text>
        <Text testID="property-price" h2 style={[styles.marginTop5, styles.fontBold]}>{price}</Text>
        <Text testID="property-type" h4 style={[styles.marginTop30, styles.fontBold]}>{type} for sale</Text>
        <Text testID="property-address" h4 style={[styles.marginTop5, styles.colorGrey]}>{address}</Text>
